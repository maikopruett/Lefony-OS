# Historical hosted-validator setup

This is an archived runbook for the retired hosted validation flow. It is not a
prerequisite for SDK development or local-SDK store publication. Use
[NATIVE-APP-SETUP.md](NATIVE-APP-SETUP.md) for the supported flow.
